<div data-testid="nav-container" class="styles_parent_nav_wrapper__rVxUu">
    <div class="styles_nav_wrapper__hImpE">
          ...
          <nav data-testid="nav" class="styles_nav__OwJwl container__8nRk6">
             <ul class="col-desktop-10 col-tablet-lg-7 col-tablet-7 col-desktop-lg-10">
                <li><a data-testid="logo" class="styles_logo_wrapper__6Axh_" href="{{ route('home') }}">
                  <img alt="Trip My Soul logo" width="140" height="32" decoding="async"
                       data-nimg="1" class="styles_logo__ktGwM"
                       src="{{ Voyager::image(setting('site.logo')) }}"
                       style="color: transparent; visibility: visible" />
              </a>
              </li>
                <li>
                   <a data-testid="link-component" id="destinations_menu_button"
                      class="styles_nav_list_item__gXRu_" href="#" onmouseover="showDropdown()" onclick="toggleDropdown()">
                      <button
                ...
                <li>
                   <a data-testid="link-component" id="travel_styles_menu_button"
                ...
                <li>
                   <a data-testid="link-component" class="styles_nav_list_item__gXRu_" href="#"
             ...
             <div data-testid="user-controls"
                ...
                <a data-testid="link-component" id="nav_search_button"
                   class="styles_user_control__NlZo_" href="#">
                   <div class="icon icon_searchControl" role="presentation">
                      <svg width="22" height="22"
                         ...
                         <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#313041" stroke-width="2" stroke-linecap="round"
                ...
                <a data-testid="link-component" class="styles_user_control__NlZo_"
                ...
                <div class="styles_user_control_profile_wrapper__wrzvd">
                   ...
                   <div style="display: none"
                      ...
                      <a data-testid="link-component"
                         href="tourscc79.html?list=upcoming">
                      ...
                      <a
                         data-testid="link-component" href="contact-us/index.html">
                         <p class="styles_profile_avatar_dropdown_link__bADCJ">Help</p>
                      </a>
                      <a data-testid="link-component" href="accounts/logout/index.html">
                         <p class="styles_profile_avatar_dropdown_link__bADCJ">
                            Log out
                         </p>
                      </a>
                   ...
                   <div style="display: none;"
                      ...
                      <a
                         data-testid="link-component" href="accounts/register/index.html">
             ...
             <div class="Search_search_header_container__5jbL4">
                <div>
                   <div class="Search_search_header_top_focus__7CE6E">
                      <div class="styles_search_input_container__8dcKA" role="search">
                         <a
                            data-testid="link-component" href="search/index.html">
                               ...
                               <div class="icon icon_searchGlass" role="presentation"
                                  ...
                                  <svg width="24" height="24"
                                     ...
                                     <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        stroke="#313041" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                     <path d="M19.6665 19.667L15.7139 15.7144" stroke="#313041"
                         ...
                         <form id="nav_search_mobile" method='get'
                            action="https://www.tripmysoul.com/search/"
                            class="hypersearchform  hypersearchmobile"><input type="search"
                            maxlength="128" name="q" ceid="Navigation Search"
                            data-testid="search-input"
                            placeholder="Where’s your next adventure?"
                            data-source="/search/autocomplete/" autocomplete="off"
                            class="hypersearch Search_search_header_input__0S5Il hypersearch-header"
                            id="navSearch" role="searchbox" value="" /><input type="hidden"
                            name="ref" value="navsearch" /></form>
                      </div>
                   </div>
                </div>
                ...
                <div>
                   <a data-testid="link-component" href="search/index.html">
                      <button
                         class="styles_button__9Iy0U styles_button_sm__bg1VW styles_button_ghost__cuQN3"
                         type="button">
       ...
       <!--Destinations -->
       <div id="destinations_dropdown_panel" style="display: none" class="" onmouseover="showDropdown()" onmouseout="hideDropdown()">
        <div data-testid="nav-drop-down" class="container__8nRk6 styles_nav_dropdown_wrapper__I9voU col-desktop-2 col-tablet-lg-1 col-desktop-lg-2 col-tablet-1" style="display: block">
            <div class="styles_destination_explorer_wrapper__wOiK8">
                <div class="styles_nav_dropdown_navigator_wrapper__3gNU1">
                    ...
                    @foreach($places as $place)
                        @if (in_array($place->name_state, ['Uttrakhand', 'Himachal Pradesh']) && !in_array($place->name_state, $displayedStates))
                            @php $displayedStates[] = $place->name_state; @endphp
                            <div class="styles_nav_dropdown_selector__OTc81">
                                <button type="button" id="{{ $place->name_state }}" class="styles_nav_dropdown_navigation_button__DMXKE" onmouseover="showDestinations('{{ $place->name_state }}')">
                                    <span>{{ $place->name_state }}</span>
                                    <div class="icon icon_chevronRight" role="presentation">
                                        <svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 9L5 5L1 1" stroke="#BEB8C4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                    </div>
                                </button>
                            </div>
                ...
                <div id="swaps">
                    @foreach($places as $place)
                        ...
                        <div data-testid="{{ $place->name_state }}" class="styles_continent_destinations_wrapper__5ssDy" style="display: none;">
                            <div class="styles_continent_destination_wrapper__Fl_Hb">
                                ...
                                <ul class="styles_destinations_lists_wrapper__VJPol">
                                    @foreach($places as $innerPlace)
                                        ...
                                        <li>
                                            <a data-testid="link-component" href="{{ $innerPlace->destination_url }}">{{ $innerPlace->destination }}</a>
                                        </li>
                                        @endif
                                    @endforeach
                                </ul>
                                <a data-testid="link-component" href="{{ $place->view_all_url }}">
                                    <button class="styles_button__9Iy0U styles_button_sm__bg1VW styles_button_ghost__cuQN3" type="button">
                                        ...
                                        <svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 9L5 5L1 1" stroke="#4c4f56" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                    </button>
                                </a>
                            </div>
    ...
    <div id="travel_styles_dropdown_panel" style="display: none" class="">
       <div data-testid="nav-drop-down"
          ...
          <div class="styles_ways_to_travel_wrapper__On0BU">
             ...
             <div id="swaps">
                <div data-testid="Trip My Soul Land"
                      ...
                      <div>
                         <div class="styles_ways_group_wrapper__Pqrca">
                            <ul class="styles_ways_lists_wrapper__6dYe3"><a
                               ...
                               href="travel-styles/classic/index.html">Classic</a><a
                               data-testid="link-component"
                               href="travel-styles/wellness/index.html">Wellness</a><a
                               data-testid="link-component"
                               ...
                               Living</a><a data-testid="link-component"
                                  ...
                                  data-testid="link-component"
                                  href="travel-styles/active/index.html">Active</a><a
                                  data-testid="link-component"
                                  href="travel-styles/family/index.html">Family</a>
                            </ul>
                         </div>
                      </div>
                   </div>
                   <img alt="Trip My Soul Land" loading="lazy" width="280" height="316"
                ...
                <div data-testid="Trip My Soul Sailing & Cruises" style="display: none"
                   ...
                   <img alt="Trip My Soul Sailing &amp; Cruises" loading="lazy" width="280"
                      height="316" decoding="async" data-nimg="1"
                ...
                <div data-testid="Trip My Soul Private Travel" style="display: none"
                   ...
                   <div>
                      ...
                      <a data-testid="link-component"
                         href="travel-styles/private-travel/index.html">
                         <button
                            class="styles_learn_more_button__nnCDV" type="button">
                            <span>Learn
                            more</span>
                   ...
                   <img alt="Trip My Soul Private Travel" loading="lazy" width="280"
                      height="316" decoding="async" data-nimg="1"
                      class="styles_display_image__LzFyK"
                ...
                <div data-testid="The_Geluxe_Collection" style="display: none"
                   ...
                   <div>
                      ...
                      <a data-testid="link-component"
                         href="travel-styles/geluxe/index.html">
                         <button
                            class="styles_learn_more_button__nnCDV" type="button">
                            <span>Learn
                            more</span>
                ...
                <div data-testid="National Geographic Journeys" style="display: none"
                   ...
                   <div>
                      ...
                      <a data-testid="link-component"
                         href="travel-styles/national-geographic-journeys/index.html">
                         <button
                            class="styles_learn_more_button__nnCDV" type="button">
                            <span>Learn
                            more</span>
                   ...
                   <img alt="National Geographic Journeys" loading="lazy" width="280"
                      height="316" decoding="async" data-nimg="1"
                      class="styles_display_image__LzFyK"
                ...
                <div data-testid="Roamies by Hostelworld" style="display: none"
                   ...
                   <div>
                      ...
                      <a data-testid="link-component"
                         href="travel-styles/roamies/index.html">
                         <button
                            class="styles_learn_more_button__nnCDV" type="button">
                            <span>Learn
                            more</span>
                   ...
                   <img alt="Roamies by Hostelworld" loading="lazy" width="280" height="316"
                      decoding="async" data-nimg="1" class="styles_display_image__LzFyK"
    ...
    <!-- /Travel Styles --><!-- Why Trip My Soul -->
          ...
          <div class="styles_why_travel_with_g_wrapper__J7xT4">
             <div class="styles_nav_dropdown_navigator_wrapper__3gNU1">
                <div class="styles_nav_dropdown_selector__OTc81">
                   ...
                   <button type="button" id="Trees for Days"
                      class="styles_nav_dropdown_navigation_button__DMXKE">
                      <span>Trees for
                      Days</span>
                      <div class="icon icon_chevronRight" role="presentation">
                   ...
                   <button type="button" id="Travel resources"
                      class="styles_nav_dropdown_navigation_button__DMXKE">
                      <span>Travel
                      Resources</span>
                      <div class="icon icon_chevronRight" role="presentation">
             ...
             <div id="swaps">
                <div data-testid="Why choose us" style="display: none"
                   ...
                   <div>
                      ...
                      <a data-testid="link-component"
                         href="about-us/why-travel-with-tripmysoul/index.html">
                         <button
                            class="styles_learn_more_button__7kukR" type="button">
                            <span>Learn
                            more</span>
                            <svg width="6" height="10" viewBox="0 0 6 10"
                               fill="none" xmlns="http://www.w3.org/2000/svg">
                   ...
                   <img alt="travel-reason" loading="lazy" width="280" height="280"
                      decoding="async" data-nimg="1" class="styles_display_image__8aXvF"
                ...
                <div data-testid="G for Good" style="display: none"
                   ...
                   <div>
                      ...
                      <a data-testid="link-component"
                         href="about-us/responsible-travel/index.html">
                         <button
                            class="styles_learn_more_button__7kukR" type="button">
                            <span>Learn
                            more</span>
                ...
                <div data-testid="Trees for Days" style="display: none"
                   ...
                   <div>
                      ...
                      <a data-testid="link-component"
                         href="community-tourism/trees-for-days">
                         <button
                            class="styles_learn_more_button__7kukR" type="button">
                            <span>Learn
                            more</span>
          ...
          <div class="styles_travel_deals_wrapper__2CAQL">
             <div class="styles_nav_dropdown_navigator_wrapper__3gNU1">
                <div class="styles_nav_dropdown_selector__OTc81">
                   ...
                   <button type="button" id="Loyalty Discount"
                      class="styles_nav_dropdown_navigation_button__DMXKE">
                      <span>Loyalty
                      Discount</span>
                      <div class="icon icon_chevronRight" role="presentation">
                   ...
                   <button type="button" id="All Travel Deals"
                      class="styles_nav_dropdown_navigation_button__DMXKE">
                      <span>All Travel
                      Deals</span>
                      <div class="icon icon_chevronRight" role="presentation">
             ...
             <div id="swaps">
                <div data-testid="Last Minute Travel Deals" style="display: none"
                   class="styles_deals_wrapper__MwvMS">
                   <div class="styles_deal_wrapper__hchdT">
                      ...
                      <a data-testid="link-component"
                         href="travel-deals/last-minute-travel-deals/index.html">
                         <button
                            class="styles_button__9Iy0U styles_button_sm__bg1VW styles_button_ghost__cuQN3"
                            type="button">
                   ...
                   <div class="styles_display_image__bU6AC"><img alt="travel-deal" loading="lazy"
                      width="281" height="211" decoding="async" data-nimg="1"
                ...
                <div data-testid="Loyalty Discount" style="display: none"
                   class="styles_deals_wrapper__MwvMS">
                   <div class="styles_deal_wrapper__hchdT">
                ...
                <div data-testid="Student Discount" style="display: none"
                   class="styles_deals_wrapper__MwvMS">
                   <div class="styles_deal_wrapper__hchdT">
                      ...
                      <a data-testid="link-component"
                         href="travel-deals/student-travel-deals/index.html">
                         <button
                            class="styles_button__9Iy0U styles_button_sm__bg1VW styles_button_ghost__cuQN3"
                            type="button">
                ...
                <div data-testid="All Travel Deals" style="display: none"
                   class="styles_deals_wrapper__MwvMS">
                   <div class="styles_deal_wrapper__hchdT">
 ...
 <div aria-labelledby="mobileheader" class="Mobile_mobile_container__AwGM8">
    <div class="Mobile_mobile_logo__UqXxy"><a href="index.html"><img alt="G-Adventures logo"
       data-testid="mobile-logo" width="140" height="32" decoding="async" data-nimg="1"
       src="{{ Voyager::image(setting('site.logo')) }}"
    ...
    <div class="Mobile_mobile_right_side__xvgES">
       <div role="presentation" data-testid="mobile-avatar-section">
          <button type="button"
             class="Mobile_user_control__Wd9Lr undefined">
             <div class="icon icon_user" role="presentation">
                <svg width="24" height="24"
                   viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                   <path
       ...
       <div class="Modal_modal_container__SpUvL DropdownSelect_dropdown-select-modal__95CRV"
          ...
          <div class="Destinations_destination_container__Wff2N">
             ...
             <div data-testid="accordionItem"
                ...
                <div id="collapse-:r17:" class="styles_accordion_collapse__9YZG7"
                   ...
                   <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                      <ul>
                         <a data-testid="link-component"
                            href="destinations/north-america/canada/index.html">
                            <li>Canada</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/north-america/united-states/index.html">
                            <li>United States</li>
                         </a>
                      </ul>
                   </div>
             ...
             <div data-testid="accordionItem"
                ...
                <div id="collapse-:r19:" class="styles_accordion_collapse__9YZG7"
                   ...
                   <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                      <ul>
                         <a data-testid="link-component"
                            href="destinations/central-america/belize/index.html">
                            <li>Belize</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/central-america/costa-rica/index.html">
                            <li>Costa Rica</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/central-america/cuba/index.html">
                            <li>Cuba</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/central-america/el-salvador/index.html">
                            <li>El Salvador</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/central-america/guatemala/index.html">
                            <li>Guatemala</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/central-america/honduras/index.html">
                            <li>Honduras</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/central-america/mexico/index.html">
                            <li>Mexico</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/central-america/nicaragua/index.html">
                            <li>Nicaragua</li>
                         </a>
                      </ul>
                   </div>
             ...
             <div data-testid="accordionItem"
                ...
                <div id="collapse-:r1b:" class="styles_accordion_collapse__9YZG7"
                   ...
                   <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                      <ul>
                         <a data-testid="link-component"
                            href="destinations/south-america/argentina/index.html">
                            <li>Argentina</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/south-america/bolivia/index.html">
                            <li>Bolivia</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/south-america/brazil/index.html">
                            <li>Brazil</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/south-america/chile/index.html">
                            <li>Chile</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/south-america/colombia/index.html">
                            <li>Colombia</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/south-america/ecuador/index.html">
                            <li>Ecuador</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/south-america/falkland-islands/index.html">
                            <li>Falkland Islands</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/south-america/galapagos/index.html">
                         ...
                         <a data-testid="link-component"
                            href="destinations/south-america/machu-picchu/index.html">
                            <li>Machu Picchu</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/south-america/peru/index.html">
                            <li>Peru</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/south-america/uruguay/index.html">
                            <li>Uruguay</li>
                         </a>
                      </ul>
                   </div>
             ...
             <div data-testid="accordionItem"
                ...
                <div id="collapse-:r1d:" class="styles_accordion_collapse__9YZG7"
                   ...
                   <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                      <ul>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/albania/index.html">
                            <li>Albania</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/austria/index.html">
                            <li>Austria</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/belgium/index.html">
                            <li>Belgium</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/bulgaria/index.html">
                            <li>Bulgaria</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/bosnia-and-herzegovina/index.html">
                            <li>Bosnia and Herzegovina</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/czech-republic/index.html">
                            <li>Czech Republic</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/canary-islands/index.html">
                            <li>Canary Islands</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/croatia/index.html">
                            <li>Croatia</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/france/index.html">
                            <li>France</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/germany/index.html">
                            <li>Germany</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/greece/index.html">
                            <li>Greece</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/hungary/index.html">
                            <li>Hungary</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/monaco/index.html">
                            <li>Monaco</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/montenegro/index.html">
                            <li>Montenegro</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/netherlands/index.html">
                            <li>Netherlands</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/norway/index.html">
                            <li>Norway</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/poland/index.html">
                            <li>Poland</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/iceland/index.html">
                            <li>Iceland</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/ireland/index.html">
                            <li>Ireland</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/italy/index.html">
                            <li>Italy</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/portugal/index.html">
                            <li>Portugal</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/romania/index.html">
                            <li>Romania</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/scotland/index.html">
                            <li>Scotland</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/spain/index.html">
                            <li>Spain</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/serbia/index.html">
                            <li>Serbia</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/switzerland/index.html">
                            <li>Switzerland</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/turkey/index.html">
                            <li>Turkey</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/kedarnath/united-kingdom/index.html">
             ...
             <div data-testid="accordionItem"
                ...
                <div id="collapse-:r1f:" class="styles_accordion_collapse__9YZG7"
                   ...
                   <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                      <ul>
                         <a data-testid="link-component"
                            href="destinations/north-africa-middle-east/egypt/index.html">
                            <li>Egypt</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/north-africa-middle-east/israel/index.html">
                            <li>Israel</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/north-africa-middle-east/jordan/index.html">
                            <li>Jordan</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/north-africa-middle-east/morocco/index.html">
                            <li>Morocco</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/north-africa-middle-east/oman/index.html">
                            <li>Oman</li>
                         </a>
                      </ul>
                   </div>
             ...
             <div data-testid="accordionItem"
                ...
                <div id="collapse-:r1h:" class="styles_accordion_collapse__9YZG7"
                   ...
                   <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                      <ul>
                         <a data-testid="link-component"
                            href="destinations/africa/botswana/index.html">
                            <li>Botswana</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/africa/kenya/index.html">
                            <li>Kenya</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/africa/madagascar/index.html">
                            <li>Madagascar</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/africa/malawi/index.html">
                            <li>Malawi</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/africa/namibia/index.html">
                            <li>Namibia</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/africa/rwanda/index.html">
                            <li>Rwanda</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/africa/south-africa/index.html">
                            <li>South Africa</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/africa/tanzania/index.html">
                            <li>Tanzania</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/africa/uganda/index.html">
                            <li>Uganda</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/africa/zambia/index.html">
                            <li>Zambia</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/africa/zimbabwe/index.html">
                            <li>Zimbabwe</li>
                         </a>
                      </ul>
                   </div>
                ...
                <div id="collapse-:r1j:" class="styles_accordion_collapse__9YZG7"
                   ...
                   <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                      <ul>
                         ...
                         <a data-testid="link-component"
                            href="destinations/asia/borneo/index.html">
                            <li>Borneo</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/bhutan/index.html">
                            <li>Bhutan</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/cambodia/index.html">
                            <li>Cambodia</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/india/index.html">
                            <li>India</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/indonesia/index.html">
                            <li>Indonesia</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/japan/index.html">
                            <li>Japan</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/laos/index.html">
                            <li>Laos</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/maldives/index.html">
                            <li>Maldives</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/malaysia/index.html">
                            <li>Malaysia</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/mongolia/index.html">
                            <li>Mongolia</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/nepal/index.html">
                            <li>Nepal</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/singapore/index.html">
                            <li>Singapore</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/south-korea/index.html">
                            <li>South Korea</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/sri-lanka/index.html">
                            <li>Sri Lanka</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/thailand/index.html">
                            <li>Thailand</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/turkmenistan/index.html">
                            <li>Turkmenistan</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/uzbekistan/index.html">
                            <li>Uzbekistan</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/asia/vietnam/index.html">
                            <li>Vietnam</li>
                         </a>
                      </ul>
                   </div>
             ...
             <div data-testid="accordionItem"
                ...
                <div id="collapse-:r1l:" class="styles_accordion_collapse__9YZG7"
                   ...
                   <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                      <ul>
                         <a data-testid="link-component"
                            href="destinations/oceania/australia/index.html">
                            <li>Australia</li>
                         </a>
                         <a data-testid="link-component"
                            href="destinations/oceania/new-zealand/index.html">
                            <li>New Zealand</li>
                         </a>
                      </ul>
                   </div>
             ...
             <div>
                <div data-testid="accordionItem"
                   class="styles_accordion_item__z982c styles_accordion_item_compact__LN9LC destination-regions">
                   <button id="heading-:r1n:" type="button" class="styles_accordion_toggle__nMAeY"
                      aria-expanded="false" aria-controls="collapse-:r1n:">
                   ...
                   <div id="collapse-:r1n:" class="styles_accordion_collapse__9YZG7"
                      aria-labelledby="heading-:r1n:" style="height: 0px">
                      <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                         <ul>
                            <a data-testid="link-component"
                ...
                <div class="Search_search_mobile_top_focus__cbNAo">
                   ...
                   <div class="styles_search_input_container__8dcKA" role="search">
                      <a
                         data-testid="link-component" href="search/index.html">
                         <div
                            class="styles_search_input_search_icon__pGrGh styles_search_input_search_icon_left__tascK">
                            <div class="icon icon_searchGlass" role="presentation"
                               style="width: 16px; height: 16px">
                               <svg width="24" height="24"
                                  viewBox="0 0 24 24" fill="none"
                      ...
                      <form id="nav_search" method='get' action="https://www.tripmysoul.com/search/"
                         class="hypersearchform "><input type="search" maxlength="128" name="q"
                         ceid="Navigation Search" data-testid="search-input"
                         placeholder="Where’s your next adventure?"
                         data-source="/search/autocomplete/" autocomplete="off"
                         class="hypersearch hypersearch-mobile Search_search_mobile_input__Tlp4P"
                         id="navSearch" role="searchbox" value="" /><input type="hidden"
                         name="ref" value="navsearch" /></form>
                   </div>
                </div>
    ...
    <div data-testid="Menu" id="jollof_menu" style="display: none" class="Modal_modal_overlay__bCKGC">
       <div class="Modal_modal_container__SpUvL DropdownSelect_dropdown-select-modal__95CRV"
          ...
          <div class="Menu_menu_container__c_7f1">
             ...
             <div data-testid="accordionItem"
                class="styles_accordion_item__z982c styles_accordion_item_compact__LN9LC menu-items">
                <button id="heading-:r1r:" type="button" class="styles_accordion_toggle__nMAeY"
                   aria-expanded="false" aria-controls="collapse-:r1r:">
                ...
                <div id="collapse-:r1r:" class="styles_accordion_collapse__9YZG7"
                   aria-labelledby="heading-:r1r:" style="height: 0px">
                   <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                      <ul>
                         <li><a data-testid="link-component"
                            href="travel-styles/classic/index.html">Classic</a></li>
                         <li><a data-testid="link-component"
                            href="travel-styles/wellness/index.html">Wellness</a></li>
                         <li><a data-testid="link-component"
                            href="travel-styles/local-living/index.html">Local Living</a></li>
                         <li><a data-testid="link-component"
                            href="travel-styles/18-to-30somethings/index.html">18-to-Thirtysomethings</a>
                         </li>
                         <li><a data-testid="link-component"
                            href="travel-styles/active/index.html">Active</a></li>
                         <li><a data-testid="link-component"
                            href="travel-styles/family/index.html">Family</a></li>
                         <li><a data-testid="link-component"
                         ...
                         <li><a data-testid="link-component"
                            href="travel-styles/cruising/river/amazon/index.html">Amazon River
                            Cruises</a>
                         </li>
                         <li><a data-testid="link-component"
                            href="travel-styles/cruising/sailing/index.html">Sailing</a></li>
                         <li><a data-testid="link-component"
                            href="travel-styles/private-travel/index.html">Private Travel</a>
                         </li>
                         <li><a data-testid="link-component"
                            href="travel-styles/geluxe/index.html">The Geluxe Collection</a>
                         </li>
                         <li><a data-testid="link-component"
                         ...
                         <li><a data-testid="link-component"
                            href="travel-styles/roamies/index.html">Roamies</a></li>
                      </ul>
                   </div>
                </div>
             </div>
             <div data-testid="accordionItem"
                ...
                <div id="collapse-:r1t:" class="styles_accordion_collapse__9YZG7"
                   ...
                   <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                      <ul>
                         <li><a data-testid="link-component"
                            href="about-us/why-travel-with-tripmysoul/index.html">Why Choose
                            us</a>
                         </li>
                         <li><a data-testid="link-component"
                            href="about-us/responsible-travel/index.html">G for Good</a></li>
                         <li><a data-testid="link-component"
                            href="https://planeterra.org/">Planeterra</a></li>
                         <li><a data-testid="link-component"
                            href="community-tourism/trees-for-days">Trees for Days</a></li>
                      </ul>
                   </div>
                </div>
             </div>
             <div data-testid="accordionItem"
                ...
                <div id="collapse-:r1t:" class="styles_accordion_collapse__9YZG7"
                   ...
                   <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                      <ul>
                         <li><a data-testid="link-component"
                            href="travel-resources/travel-credits/index.html">How to use your
                            travel credits</a>
                         </li>
                         <li><a data-testid="link-component"
                            href="travel-resources/prepare-for-your-tour/index.html">Preparing
             ...
             <div data-testid="accordionItem"
                class="styles_accordion_item__z982c styles_accordion_item_compact__LN9LC menu-items">
                <button id="heading-:r1v:" type="button" class="styles_accordion_toggle__nMAeY"
                   aria-expanded="false" aria-controls="collapse-:r1v:">
                ...
                <div id="collapse-:r1v:" class="styles_accordion_collapse__9YZG7"
                   aria-labelledby="heading-:r1v:" style="height: 0px">
                   <div data-testid="accordion_body" class="styles_accordion_body__4vvJA">
                      <ul>
                         <li><a data-testid="link-component"
